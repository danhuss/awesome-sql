...
- ~~[Poor SQL](http://poorsql.com/)~~ - Instant Free and Open-Source T-SQL Formatting (This site's down, try here for the plugins and whatnot: https://github.com/TaoK/PoorMansTSqlFormatter )
