...
- [dbt Fundamentals](https://learn.getdbt.com/courses/dbt-fundamentals) - Learn how to build modular data transformations using SQL in real-world data workflows.